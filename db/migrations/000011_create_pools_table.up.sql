...
INSERT INTO resources (name) VALUES ('pools.view'), ('pools.create'), ('pools.update'), ('pools.delete');
...
WITH admin_role_id AS (SELECT id FROM roles WHERE name = 'admin')
	INSERT INTO role_to_resources (role_id, resource_id)
		SELECT admin_role_id.id, resources.id FROM resources, admin_role_id WHERE resources.name IN ('pools.view', 'pools.create', 'pools.update', 'pools.delete');
